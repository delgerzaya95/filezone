...
if ($price_range !== 'all') {
    switch ($price_range) {
        case 'free':
            ...
            break;
        case '0-5000':
            $where[] = "f.price BETWEEN 0 AND 5000";
            break;
        case '5000-10000':
            $where[] = "f.price BETWEEN 5000 AND 10000";
            break;
        case '10000+':
            $where[] = "f.price > 10000";
            break;
...
if (!empty($params)) {
    $types = str_repeat('s', count($params)); // Use 's' for string parameters
    mysqli_stmt_bind_param($countStmt, $types, ...$params);
}
mysqli_stmt_execute($countStmt);
$countResult = mysqli_stmt_get_result($countStmt);
$totalFiles = mysqli_fetch_assoc($countResult)['total_files'];
...
if (!empty($params)) {
    $types = str_repeat('s', count($params) - 2) . 'ii'; // Last two parameters are integers
...
<main class="container mx-auto px-4 py-8">
    <div class="text-center mb-10">
        <h1 class="text-3xl font-bold text-gray-800 mb-4">Бүх Файлууд</h1>
        <p class="text-gray-600 max-w-2xl mx-auto">Системд байгаа бүх файлуудын жагсаалт</p>
    </div>
        ...
        <div class="divide-y divide-gray-200">
            ...
            <?php else: ?>
                <div class="py-12 text-center">
                    ...
                    <a href="browse-files.php" class="mt-4 inline-block bg-purple-600 hover:bg-purple-700 text-white px-6 py-2 rounded-md">
                        Бүх файлыг үзэх
                    </a>
                </div>
            <?php endif; ?>
